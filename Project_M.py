...
Air_den = 1.225 # UK's avg density of air in kg/m3
wind_speed = 12 #in m/s
Cef = 0.4 #power coefficient
Ct = 0.88 #thrust cofficient
...
def plot_farm(farm_layout,save_image=False,figure_name=''):
...
print(farm_grid)
plot_farm(farm_layout=farm_grid)
...
def hill_climbing(layout, iterations):
    ...
    current_fitness = evaluate_fitness(current_layout)
    
    for _ in range(iterations):
        new_layout = perform_random_move(current_layout)
        new_fitness = evaluate_fitness(new_layout)
...
plot_farm(farm_layout=best_layout)
...
layout = Wake_effect(best_layout)

print('Initial Layout')
# print(layout)
plot_farm(layout)
print('initial fitness',evaluate_fitness(layout))
iterations = 500
optimized_layout, best_fitness = hill_climbing(layout, iterations)

print("Optimized Layout:")
plot_farm(optimized_layout)
